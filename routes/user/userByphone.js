...
// 1.查询邀请码
var sql = "select * from customer where loginNum=? order by lastTime desc limit ?,?"

// 分页
let sqlTotal = 'select count(*) as total from customer where loginNum=?'

router.post('/Api/userByphone', function (req, res, next) {
